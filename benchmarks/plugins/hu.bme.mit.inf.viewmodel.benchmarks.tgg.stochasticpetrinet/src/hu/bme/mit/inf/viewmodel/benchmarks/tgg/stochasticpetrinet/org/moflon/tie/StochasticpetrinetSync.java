...
public class StochasticpetrinetSync extends SynchronizationHelper{

   public StochasticpetrinetSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		StochasticpetrinetSync helper = new StochasticpetrinetSync();
