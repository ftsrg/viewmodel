...
public class StochasticpetrinetTrafo extends SynchronizationHelper{

   public StochasticpetrinetTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        StochasticpetrinetTrafo helper = new StochasticpetrinetTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new StochasticpetrinetTrafo();
