...
public class SwitchPositionImpl extends AbstractRuleImpl implements SwitchPosition {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_37(EMoflonEdge _edge_positions) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SWITCH_POSITION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_37__EMOFLONEDGE:
	...
	public static final Object[] pattern_SwitchPosition_10_2_testcorematchandDECs_black_nac_0BB(
		...
		Switch __DEC_srcSwitchPosition_positions_252913 = srcSwitchPosition.getTarget();
		if (__DEC_srcSwitchPosition_positions_252913 != null) {
			if (!srcSwitch.equals(__DEC_srcSwitchPosition_positions_252913)) {
	...
	public static final Object[] pattern_SwitchPosition_13_1_matchtggpattern_black_nac_0BB(
			hu.bme.mit.inf.viewmodel.benchmarks.models.railway.SwitchPosition srcSwitchPosition, Switch srcSwitch) {
		Switch __DEC_srcSwitchPosition_positions_655473 = srcSwitchPosition.getTarget();
		if (__DEC_srcSwitchPosition_positions_655473 != null) {
			if (!srcSwitch.equals(__DEC_srcSwitchPosition_positions_655473)) {
				return new Object[] { srcSwitchPosition, srcSwitch };
			}
		}
