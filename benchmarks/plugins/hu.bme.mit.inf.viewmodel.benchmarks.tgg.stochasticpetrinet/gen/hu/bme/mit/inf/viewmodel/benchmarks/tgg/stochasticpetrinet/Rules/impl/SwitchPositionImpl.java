...
public class SwitchPositionImpl extends AbstractRuleImpl implements SwitchPosition {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_16(EMoflonEdge _edge_positions) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SWITCH_POSITION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_16__EMOFLONEDGE:
	...
	public static final Object[] pattern_SwitchPosition_10_2_testcorematchandDECs_black_nac_0BB(
			hu.bme.mit.inf.viewmodel.benchmarks.models.railway.SwitchPosition srcSwitchPosition, Switch srcSwitch) {
		Switch __DEC_srcSwitchPosition_positions_582275 = srcSwitchPosition.getTarget();
		if (__DEC_srcSwitchPosition_positions_582275 != null) {
			if (!srcSwitch.equals(__DEC_srcSwitchPosition_positions_582275)) {
	...
	public static final Object[] pattern_SwitchPosition_13_1_matchtggpattern_black_nac_0BB(
			hu.bme.mit.inf.viewmodel.benchmarks.models.railway.SwitchPosition srcSwitchPosition, Switch srcSwitch) {
		Switch __DEC_srcSwitchPosition_positions_567646 = srcSwitchPosition.getTarget();
		if (__DEC_srcSwitchPosition_positions_567646 != null) {
			if (!srcSwitch.equals(__DEC_srcSwitchPosition_positions_567646)) {
				return new Object[] { srcSwitchPosition, srcSwitch };
			}
		}
