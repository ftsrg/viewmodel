...
abstract class AbstractModelModifications {
	val Random random
	protected val RailwayContainer railwayContainer
	val List<ModelModification> schedule
	protected val AdvancedViatraQueryEngine queryEngine
	...
	new(long randomSeed, RailwayContainer railwayContainer, Map<ModelModification, Integer> mix, Notifier scopeRoot) {
		random = new Random(randomSeed)
		this.railwayContainer = railwayContainer
		this.schedule = shuffle(mix)
		queryEngine = AdvancedViatraQueryEngine.createUnmanagedEngine(new EMFScope(scopeRoot))
	...
	protected abstract def void switchCreated(Switch ^switch)
	
	protected abstract def void segmentCreated(Segment segment)
	
	protected abstract def void routeCreated(Route route)
	
	protected abstract def void routeRemoved(Route route)
