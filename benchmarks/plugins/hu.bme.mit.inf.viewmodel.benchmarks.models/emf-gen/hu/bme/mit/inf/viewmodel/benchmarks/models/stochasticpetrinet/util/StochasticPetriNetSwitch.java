...
public class StochasticPetriNetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StochasticPetriNetPackage.PETRI_NET: {
				PetriNet petriNet = (PetriNet)theEObject;
				T result = casePetriNet(petriNet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StochasticPetriNetPackage.TRANSITION: {
			...
			case StochasticPetriNetPackage.PLACE: {
			...
			case StochasticPetriNetPackage.ARC: {
				Arc arc = (Arc)theEObject;
				T result = caseArc(arc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StochasticPetriNetPackage.TIMED_TRANSITION: {
				...
				if (result == null) result = caseNode(timedTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StochasticPetriNetPackage.IMMEDIATE_TRANSITION: {
				...
				if (result == null) result = caseNode(immediateTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StochasticPetriNetPackage.NODE: {
