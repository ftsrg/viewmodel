 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.viewmodel.benchmarks.models.dependability2stochasticpetrinet.impl.RailwayContainer2PetriNetImpl#getRailwayContainer <em>Railway Container</em>}</li>
 *   <li>{@link hu.bme.mit.inf.viewmodel.benchmarks.models.dependability2stochasticpetrinet.impl.RailwayContainer2PetriNetImpl#getPetriNet <em>Petri Net</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RailwayContainer2PetriNetImpl extends TraceLinkImpl implements RailwayContainer2PetriNet {
	...
	protected EClass eStaticClass() {
		return Dependability2StochasticPetriNetPackage.Literals.RAILWAY_CONTAINER2_PETRI_NET;
	}
		...
		if (railwayContainer != null && railwayContainer.eIsProxy()) {
			...
			if (railwayContainer != oldRailwayContainer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Dependability2StochasticPetriNetPackage.RAILWAY_CONTAINER2_PETRI_NET__RAILWAY_CONTAINER, oldRailwayContainer, railwayContainer));
			}
		}
	...
	public void setRailwayContainer(RailwayContainer newRailwayContainer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dependability2StochasticPetriNetPackage.RAILWAY_CONTAINER2_PETRI_NET__RAILWAY_CONTAINER, oldRailwayContainer, railwayContainer));
	}
	...
	public PetriNet getPetriNet() {
		if (petriNet != null && petriNet.eIsProxy()) {
			...
			if (petriNet != oldPetriNet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Dependability2StochasticPetriNetPackage.RAILWAY_CONTAINER2_PETRI_NET__PETRI_NET, oldPetriNet, petriNet));
			}
		}
		return petriNet;
	}
	...
	public void setPetriNet(PetriNet newPetriNet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dependability2StochasticPetriNetPackage.RAILWAY_CONTAINER2_PETRI_NET__PETRI_NET, oldPetriNet, petriNet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dependability2StochasticPetriNetPackage.RAILWAY_CONTAINER2_PETRI_NET__RAILWAY_CONTAINER:
				if (resolve) return getRailwayContainer();
				return basicGetRailwayContainer();
			case Dependability2StochasticPetriNetPackage.RAILWAY_CONTAINER2_PETRI_NET__PETRI_NET:
