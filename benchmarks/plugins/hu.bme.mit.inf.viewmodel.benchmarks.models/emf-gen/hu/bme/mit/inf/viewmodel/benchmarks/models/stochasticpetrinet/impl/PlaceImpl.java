 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.viewmodel.benchmarks.models.stochasticpetrinet.impl.PlaceImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceImpl extends NodeImpl implements Place {
	...
	protected EClass eStaticClass() {
		return StochasticPetriNetPackage.Literals.PLACE;
	}
	...
	public void setTokens(int newTokens) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StochasticPetriNetPackage.PLACE__TOKENS, oldTokens, tokens));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StochasticPetriNetPackage.PLACE__TOKENS:
				return getTokens();
		}
