...
public class RailwaySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RailwayPackage.SWITCH: {
				hu.bme.mit.inf.viewmodel.benchmarks.models.railway.Switch switch_ = (hu.bme.mit.inf.viewmodel.benchmarks.models.railway.Switch)theEObject;
	 ...
	 * @generated
	 */
	public T caseSwitch(hu.bme.mit.inf.viewmodel.benchmarks.models.railway.Switch object) {
		return null;
	}
