 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.viewmodel.benchmarks.models.stochasticpetrinet.impl.PetriNetImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	...
	protected EClass eStaticClass() {
		return StochasticPetriNetPackage.Literals.PETRI_NET;
	}
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentWithInverseEList<Node>(Node.class, this, StochasticPetriNetPackage.PETRI_NET__NODES, StochasticPetriNetPackage.NODE__PETRI_NET);
		}
		return nodes;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StochasticPetriNetPackage.PETRI_NET__NODES:
