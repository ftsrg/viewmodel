 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.viewmodel.benchmarks.models.dependability2stochasticpetrinet.impl.PetriNetModuleTraceLinkImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link hu.bme.mit.inf.viewmodel.benchmarks.models.dependability2stochasticpetrinet.impl.PetriNetModuleTraceLinkImpl#getArcs <em>Arcs</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PetriNetModuleTraceLinkImpl extends TraceLinkImpl implements PetriNetModuleTraceLink {
	...
	protected EClass eStaticClass() {
		return Dependability2StochasticPetriNetPackage.Literals.PETRI_NET_MODULE_TRACE_LINK;
	}
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectResolvingEList<Node>(Node.class, this, Dependability2StochasticPetriNetPackage.PETRI_NET_MODULE_TRACE_LINK__NODES);
		}
		return nodes;
	}
	...
	public EList<Arc> getArcs() {
		if (arcs == null) {
			arcs = new EObjectResolvingEList<Arc>(Arc.class, this, Dependability2StochasticPetriNetPackage.PETRI_NET_MODULE_TRACE_LINK__ARCS);
		}
		return arcs;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dependability2StochasticPetriNetPackage.PETRI_NET_MODULE_TRACE_LINK__NODES:
				return getNodes();
			case Dependability2StochasticPetriNetPackage.PETRI_NET_MODULE_TRACE_LINK__ARCS:
				return getArcs();
		}
