...
import hu.bme.mit.inf.viewmodel.benchmarks.queries.virtualswitchview.TracedTrainBenchmarkQueries
import hu.bme.mit.inf.viewmodel.benchmarks.queries.virtualswitchview.TrainBenchmarkQueries
