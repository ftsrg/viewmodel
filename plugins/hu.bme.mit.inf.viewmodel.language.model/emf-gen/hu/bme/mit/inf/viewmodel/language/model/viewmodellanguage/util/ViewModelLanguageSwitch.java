 ...
 * @generated
 */
public class ViewModelLanguageSwitch<T> extends Switch<T> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public ViewModelLanguageSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ViewModelLanguagePackage.LOOKUP: {
				Lookup lookup = (Lookup)theEObject;
				T result = caseLookup(lookup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewModelLanguagePackage.LOOKUP_RESULT: {
				LookupResult lookupResult = (LookupResult)theEObject;
				T result = caseLookupResult(lookupResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>View Definition Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>View Definition Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseViewDefinitionModel(ViewDefinitionModel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Lookup Result</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Lookup Result</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLookupResult(LookupResult object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePatternLanguage_Variable(org.eclipse.viatra.query.patternlanguage.patternLanguage.Variable object) {
		return null;
	}
