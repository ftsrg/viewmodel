 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.viewmodel.language.model.viewmodellanguage.impl.NamespaceImportImpl#getImportedNamespace <em>Imported Namespace</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamespaceImportImpl extends MinimalEObjectImpl.Container implements NamespaceImport {
	...
	protected EClass eStaticClass() {
		return ViewModelLanguagePackage.Literals.NAMESPACE_IMPORT;
	}
	...
	public void setImportedNamespace(String newImportedNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewModelLanguagePackage.NAMESPACE_IMPORT__IMPORTED_NAMESPACE, oldImportedNamespace, importedNamespace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ViewModelLanguagePackage.NAMESPACE_IMPORT__IMPORTED_NAMESPACE:
