 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.viewmodel.runtime.model.logicmodel.impl.VariableImpl#getId <em>Id</em>}</li>
 *   <li>{@link hu.bme.mit.inf.viewmodel.runtime.model.logicmodel.impl.VariableImpl#getCluster <em>Cluster</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends MinimalEObjectImpl.Container implements Variable {
	...
	protected EClass eStaticClass() {
		return LogicModelPackage.Literals.VARIABLE;
	}
	...
	public void setId(long newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogicModelPackage.VARIABLE__ID, oldId, id));
	}
	...
	public Cluster getCluster() {
		if (cluster != null && cluster.eIsProxy()) {
			...
			if (cluster != oldCluster) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LogicModelPackage.VARIABLE__CLUSTER, oldCluster, cluster));
			}
		}
		return cluster;
	}
	...
	public void setCluster(Cluster newCluster) {
		...
		cluster = newCluster;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogicModelPackage.VARIABLE__CLUSTER, oldCluster, cluster));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LogicModelPackage.VARIABLE__ID:
				return getId();
			case LogicModelPackage.VARIABLE__CLUSTER:
